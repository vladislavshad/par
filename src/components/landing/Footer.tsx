    ...
    <footer className="bg-bg-secondary border-t border-white/5">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <div className="grid md:grid-cols-3 gap-12">
          <div>
            <Link href="/" className="flex items-center gap-3 mb-4">
              <span className="text-gold text-2xl font-serif font-bold tracking-[0.15em]">
                ПАРЪ
              </span>
              <span className="text-text-muted text-[10px] tracking-[0.35em] uppercase border-l border-gold/30 pl-3">
                мануфактура
              </span>
            </Link>
            <p className="text-text-muted text-sm leading-relaxed max-w-xs">
              Премиальные банные комплекты ручной работы
              с полной персонализацией.
              Москва и доставка по России.
            </p>
          </div>

          <div>
            <h4 className="font-serif text-sm font-semibold tracking-wider uppercase mb-4">
              Навигация
            </h4>
          ...
          <div>
            ...
            <div className="space-y-2 text-text-muted text-sm">
              <p>Москва, Россия</p>
              <p>+7 (999) 123-45-67</p>
              <p>hello@par-mfg.ru</p>
              <div className="flex gap-4 pt-2">
                <a href="#" className="text-text-muted hover:text-gold transition-colors" aria-label="Telegram">
                ...
                <a href="#" className="text-text-muted hover:text-gold transition-colors" aria-label="WhatsApp">
                  <svg className="w-5 h-5" viewBox="0 0 24 24" fill="currentColor">
        ...
        <div className="mt-12 pt-8 border-t border-white/5 text-center text-text-muted text-xs">
          &copy; {new Date().getFullYear()} ПАРЪ МАНУФАКТУРА. Все права защищены.
        </div>
      </div>
    </footer>
  );
